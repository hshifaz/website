...
{!! link_to_route('contentFiles.create', 'Create New Content File') !!}
    @if(count($contentFiles))
        <ul>
            ...
            <li>
                {!! link_to_route('contentFiles.edit', $contentFile->desc, array($contentFile->id)) !!}
                ...
                {!! \Collective\Html\FormFacade::open(array('route'=>array('contentFiles.destroy',$contentFile->id),'method'=>'delete','class'=>'destroy')) !!}
