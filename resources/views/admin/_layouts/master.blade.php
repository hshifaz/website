...
<head>
    ...
    <!--[if lt IE 9]>
    <script src="{!! asset('adminlte/js/custom_downloaded/html5shiv.js') !!}"></script>
    <script src="{!! asset('adminlte/js/custom_downloaded/respond.min.js')!!}"></script>
    <![endif]-->
</head>
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="{!! asset('adminlte/img/avatar2.png') !!}" class="img-circle" alt="user image"/>
                                        </div>
                                        <h4>
...
<!-- jQuery 2.0.2 -->
<script src="{!! asset('adminlte/js/custom_downloaded/jquery.min.js') !!}"></script>
<!-- Bootstrap -->
